...
TEST(BasisSetTest, NormalizesContractionsToUnitNorm) {
    // The regression guard: the parser renormalizes every contraction
...
// basisset-1 rollback: Merge used to push other's elements before the ECP
...
// basisset-2 rollback: AppendNwchemText used to append elements and shells
