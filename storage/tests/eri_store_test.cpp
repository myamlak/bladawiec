...
// slot contract of 8.6, and the append-only refusals.
...
// The class-canonical guard (the B3 addition): a run in the MIRRORED class
...
// st-1 coverage gap: the certified bounds dataset was outside every
