// The QFMM composed HF builder: F = H + 2J_QFMM(rho) - K(rho), the
// RIJCOSX-style combination point applied to QFMM. Per BuildFock
...
// BuildFock is written as those two halves in that order, and both are
...
// states (the triple-store footprint). With a
