...
// The shell-pair geometry of the QFMM octree: the expansion center and the
// conservative bounding radius of one canonical shell pair.
...
// well-defined regardless of the primitives' exponent ratio - "correctness
// over performance" is the stated design principle for this work.
...
/// Which objects and radii the pair geometry is built from (the corrected
/// form, option-gated; the default keeps the recorded form bit-identically).
...
/// The two terms of the recorded extent, per pair:
...
/// existing caller keeps its exact behavior; kProductBall is the corrected form).
