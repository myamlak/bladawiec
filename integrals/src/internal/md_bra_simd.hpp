...
// loops of MicroGemmAdd/MicroGemm
// (md_gemm.hpp) vectorized 4-wide over the n columns - the broadcast of
// A(i,l) makes every operand access contiguous. Defined in md_bra_simd.cpp,
