...
// (nI, nJ, nK, nL) = (nA, nB, nC, nD). The originally proposed formula
...
/// The per-task contraction metadata of one GPU Fock batch (named with the
/// cuda-namespace prefix convention). Every
