...
/// \file
/// The lean builder's ORBIT ACTION (the petite-list mechanism): the tables of
/// one Abelian reduction that let the streaming row walk visit ONE canonical
/// cell per symmetry orbit and expand the orbit representative's ERI block
/// over the orbit's members at contraction time - a measured 2,379,972 ERI
...
/// overhead, ~250 MB) - ~0.75 GB, the working set observed
...
/// arithmetic (the 2026-09-12 amendment, and the machinery's own class path is
/// pinned the same way, fock_build_test.cpp:772).
///
