...
/// \file
/// The lean-direct builder's irreducible per-pair state (the 2026-09-08
/// lean-direct reframe): ONE immutable record per canonical
...
/// the lean path. The record layout is the lean path's contract with its
/// tests (the 24-byte bound and the absence of heap members are
