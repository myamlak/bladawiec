// The GPU auto-selection gate: the device workspace budget mirror
...
/// Runs the step-1 gate on one fixture: probes free VRAM before Create,
...
void RunVramGate(const qcx::molecule::Molecule& molecule,
    ...
    // on the T1000 at the step-1 gate): the FIRST small cudaMalloc maps 2 MiB
    ...
    // The step-1 seam: the free-VRAM probe minus the display headroom at
    // Create (design section 5).
