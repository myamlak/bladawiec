// Octree construction of the QFMM skeleton: every shell pair lands in
// exactly one leaf, every node's box contains its children's boxes, the
// children adjacency is a genuine forest (BuildSparsityFromTree accepts it),
// and a real molecule's tree is
// structurally sane.
