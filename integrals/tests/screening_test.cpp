...
TEST(ScreeningTest, RepresentsLinkStyleNeighborListFromRealScreening) {
    ...
    // an earlier prototype. The pattern-driven screening pass must
    ...
    // ... wrapped in the shared sparsity primitive (the migrated State
...
// The per-target gate vs the legacy six-block-max gate at uniform densities
// D = c * I. The products are the CERTIFIED
