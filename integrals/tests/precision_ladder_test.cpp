// The precision-ladder builder tests: the C12
...
TEST(PrecisionLadderTest, C12ClassificationCoversAllBatches) {
    // The classification gate on the C12 alkane fixture: the classification
...
TEST(PrecisionLadderTest, Fp64CapMatchesPlainFp64Build) {
    // The fp64-cap gate (CPU half): the ladder with the fp64 cap reproduces
...
TEST(PrecisionLadderTest, ScriptedScfRunsTheSchedule) {
    // The escalation gate: a scripted SCF runs the escalation schedule - the
