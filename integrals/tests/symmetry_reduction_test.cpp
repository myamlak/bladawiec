...
// The table's containers carry the class_table allocation family's tagged
...
// (CountClassMaterialization, measured 2026-09-13): the gate charges
...
// and frees them on return; the attribution model charges the class_table family for
