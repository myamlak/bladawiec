...
/// driver, or the direct Fock builders) supplies screened
...
/// 512 MiB is the
/// repo's standard batch cap (EriBatchOptions::maxBatchBytes), so the sweep
/// chunks at the same granularity every other batched allocation uses.
