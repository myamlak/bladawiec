...
/// method allows in principle, and exactly the representation the stage
/// plan names ("block eigen-decompositions of the Gopinathan-Jug P_ort
/// blocks"). The atomic blocks of P_ort replace the NAO blocks of the
