// The three pinned SCF energies through the retained dense path (Step 1 of
// ): the general-l MD 1e matrices + BuildEriTensorGeneral
...
//
// Provenance: H2 -1.1167143252 has the three-chain record of (mpmath
