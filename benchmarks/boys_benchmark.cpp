// Boys-function kernel benchmarks.
//
...
#if QcxIntegralsFp16
// The fp16 lane: F16/Bf16 I/O around the certified fp32 engine (the
// half-type boundary extension). Inputs round the double x grid to the half type -
