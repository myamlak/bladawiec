// The GPU competitor kernels: the erf-F0 and the Tsuji-style gridded-LUT
// lanes, compiled by nvcc. Mirrors the qcx-integrals split (boys_cuda.cpp /
// boys_cuda.cu): the host translation unit includes only the extern "C" seam
// in boys_cuda_benchmark_kernels.hpp (qcx C++23 headers would poison an nvcc
// TU at CMAKE_CUDA_STANDARD 20).
