...
// The extern "C" seam to
// boys_cuda_benchmark_kernels.cu (nvcc). Keep this header free of qcx C++23
// headers — the .cu translation unit is compiled at CMAKE_CUDA_STANDARD 20.
