// Wall time of the plain DiagonalizeFock vs the AO-space symmetry-blocked
// path, which diagonalizes once per irreducible representation, at a
// mid-size molecule with real, non-C1 symmetry (benzene: D6h detected,
// D2h computational group). The
