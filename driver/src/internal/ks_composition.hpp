...
//
// The scf module's energy seam the Kohn-Sham arm separates the energy the SCF
...
/// spin potentials, from grid's engine (a callback seam, so the
...
///   nothing either. VERIFIED at its landing (`1436bd93`), not assumed from
