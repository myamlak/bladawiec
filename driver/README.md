...
- `docs/api-guide.md` — the public API the headers expose.
- `docs/input-guide.md` — every section and key of the input file.
- `docs/output-guide.md` — the report file and the JSON document.
