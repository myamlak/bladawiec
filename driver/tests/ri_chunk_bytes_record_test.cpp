// The ri_chunk_bytes request record, end to end through the driver:
// the disclosure arm of the key split (the owner's ruling 2026-09-13). The
...
// run proceeds and the hint is never read. Dropping it is the ruled behaviour
