// The size-class accuracy report of the composed QFMM runs: the pre-registered
// bin assignment of a
...
TEST(AccuracyClassReportTest, AlkaneChainFixtureCountsAreMachineCounted) {
    ...
    // C12H26 and 170 for C24H50 (the "194" of the gate comments is
...
TEST(AccuracyClassReportTest, TableFitsTheScalingLawOnThreeOrMoreFixtures) {
    ...
    // (the measured C ~ 0.4 for n-alkanes at the kLoose density gate): the
