...
// Toy CRTP skeleton: the base drives the iteration shape, derived classes
// fill in the method-specific pieces - all static dispatch, no virtuals.
...
// fully monomorphized code underneath. The variant stays CI-safe because
// Backend<CudaTag>'s header has no CUDA includes and only its inline
// DeviceId() is instantiated here.
