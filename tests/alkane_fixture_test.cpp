...
// carbonCount = 12 (qfmm_fock_build_test.cpp,
// qfmm_monopole_test.cpp, qfmm_lmult_test.cpp), so the kInvalidArgument error
// path and the small-carbon geometry branches are only pinned here - a
// geometry bug in the methane/ethane branches would otherwise pass every
// suite.
