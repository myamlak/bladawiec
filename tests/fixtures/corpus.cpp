...
qcx::Result<qcx::molecule::Molecule> MakeGenericC1() {
    ...
    // and the best it can do is Cs - a triatomic C1 test
    // molecule is not actually C1.)
...
qcx::Result<qcx::molecule::Molecule> MakeD2dSynthetic() {
    ...
    // D2-family S4-axis principal rule (the fallback ranks the C2'
    // above the S4-axis C2 on the atom-fixed counts alone).
